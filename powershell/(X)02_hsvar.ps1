# HS VaR (Beta 적용) 자동화 작업 연동 배치 스크립트

$baseDate = $args[0]

$GetSeqUri = 'http://localhost:5000/v2/flow/sequence/@sequence,HS_VaR_Beta,M@'
...
$Body = '{
    flow_id: 164,
    operator_params: "[{\"default\":\"20210531\",\"type\":\"date\",\"value\":\"' + $baseDate + '\",\"value_name\":\"@BaseDate\",\"name\":\"기준일\",\"hide\":false},{\"default\":\"@sequence,N\",\"type\":\"text\",\"value\":\"N\",\"value_name\":\"@RWA_YN\",\"name\":\"지주전송월작업여부\",\"hide\":false},{\"default\":\"BETA\",\"type\":\"text\",\"value\":\"BETA\",\"value_name\":\"@Path\",\"name\":\"생성폴더\",\"hide\":false},{\"default\":\"@sequence,HS_VaR_Beta,M@\",\"type\":\"text\",\"value\":\"' + $Sequence + '\",\"value_name\";\"@seq\",\"name\":\"seq\",\"hide\":false}]"
    }'
