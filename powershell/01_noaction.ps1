# 가상손익 자동화 작업 연동 배치 스크립트

$baseDate = $args[0]

$GetWorkDayUri = 'http://localhost:5000/v2/flow/workday/before/' + $baseDate
$baseDate = Invoke-RestMethod -Method 'Get' -Uri $GetWorkDayUri -UseDefaultCredential
...
$Body = '{
    ...
    operator_params: "[{\"type\":\"text\",\"value\":\"' + $baseDate + '\",\"value_name\":\"@BaseDate\",\"name\":\"기준일자\",\"hide\":false},
                       {\"type\":\"text\",\"value\":\"N\",\"value_name\":\"@RWA_YN\",\"name\":\" 지주전송월데이터여부\",\"hide\":false},
                       {\"type\":\"text\",\"value\":\"NOACTION\",\"value_name\":\"@Path\",\"name\":\"생성폴더\",\"hide\":true},
                       {\"type\":\"text\",\"value\":\"' + $Sequence + '\",\"value_name\":\"@Seq\",\"name\":\"seq\",\"hide\":true}]"
}'
