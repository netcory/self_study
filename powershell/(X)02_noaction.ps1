...
$GetSeqUri = 'http://localhost:5000/v2/flow/sequence/@sequence,HS_VaR_Virtue,M@'
...
$Body = '{
    flow_id: 147,
    operator_params: "[{\"default\":\"20210531\",\"type\":\"text\",\"value\":\"' + $baseDate + '\",\"value_name\":\"@BaseDate\",\"name\":\"기준일자\",\"hide\":false}, {\"default\":\"@sequence,N\",\"type\":\"text\",\"value\":\"N\",\"value_name\":\"@RWA_YN\",\"name\":\" 지주전송월데이터여부\",\"hide\":false},{\"default\":\"NOACTION\",\"type\":\"text\",\"value\":\"NOACTION\",\"value_name\":\"@Path\",\"name\":\"생성폴더\",\"hide\":true},{\"default\":\"@sequence,HS_VaR_Virtue,M@\",\"type\"text\",\"value\":\"' + $Sequence + '\",\"value_name\":\"@Seq\",\"name\":\"seq\",\"hide\":true}]"
}'
